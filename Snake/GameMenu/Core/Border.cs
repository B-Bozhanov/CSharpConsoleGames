namespace GameMenu.Core
{
    ...
    public class Border
    {
        ...
        public string InfoWindow()
        {
            ...
            for (int i = 0; i < this.field.InfoWindow.Row; i++)
            {
            string middleLine = null!;
                middleLine += MiddleVerticalLine;
                middleLine += new string(Empty, this.field.InfoWindow.Col - 2);
                middleLine += MiddleVerticalLine;
            ...
            endLine += new string(MiddleHorizontalLine, this.field.InfoWindow.Col - 2);
        ...
        public string Walls()
        {
            ...
            for (int i = 5; i < this.field.WindowHeight; i++)
            {
            string middleLine = null!;
                middleLine += MiddleVerticalLine;
                middleLine += new string(Empty, this.field.InfoWindow.Col - 2);
